...
export default class ConcordiumNodeClient {
     ...
     */
    getNextAccountNonce(accountAddress: AccountAddress): Promise<v1.NextAccountNonce>;
    /**
     ...
     */
    getCryptographicParameters(blockHash?: HexString): Promise<v1.CryptographicParameters>;
    /**
     ...
     */
    getAccountInfo(accountIdentifier: v1.AccountIdentifierInput, blockHash?: HexString): Promise<v1.AccountInfo>;
    /**
     ...
     */
    getBlockItemStatus(transactionHash: HexString): Promise<BlockItemStatus>;
    /**
     * Retrieves the consensus status information from the node. Note that the optional
     * fields will only be unavailable for a newly started node that has not processed
     * enough data yet.
     ...
     */
    getModuleSource(moduleRef: ModuleReference, blockHash?: HexString): Promise<Buffer>;
    /**
     ...
     */
    getInstanceInfo(contractAddress: v1.ContractAddress, blockHash?: HexString): Promise<v1.InstanceInfo>;
    /**
     ...
     */
    invokeContract(context: v1.ContractContext, blockHash?: HexString): Promise<v1.InvokeContractResult>;
    /**
     ...
     */
    sendAccountTransaction(transaction: v1.AccountTransaction, signature: v1.AccountTransactionSignature): Promise<HexString>;
    /**
     ...
     */
    sendCredentialDeploymentTransaction(credentialDeploymentTransaction: v1.CredentialDeploymentTransaction, signatures: string[]): Promise<HexString>;
    /**
     ...
     */
    getBlockChainParameters(blockHash?: HexString): Promise<v1.ChainParameters>;
    /**
     ...
     */
    getPoolInfo(bakerId: v1.BakerId, blockHash?: HexString): Promise<v1.BakerPoolStatus>;
    /**
     * Retrieves information on the passive delegators.
     * @param blockHash the block hash of the block to get the information from.
     * @returns The status of the passive delegators.
     */
    getPassiveDelegationInfo(blockHash?: HexString): Promise<v1.PassiveDelegationStatus>;
    /**
     ...
     */
    getTokenomicsInfo(blockHash?: HexString): Promise<v1.TokenomicsInfo>;
    /**
     ...
     */
    waitForTransactionFinalization(transactionHash: HexString, timeoutTime?: number): Promise<HexString>;
    /**
     ...
     */
    getAccountList(blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<Base58String>;
    /**
     ...
     */
    getModuleList(blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<HexString>;
    /**
     ...
     */
    getAncestors(maxAmountOfAncestors: bigint, blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<HexString>;
    /**
     ...
     */
    getInstanceState(contractAddress: v1.ContractAddress, blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<v1.InstanceStateKVPair>;
    /**
     ...
     */
    instanceStateLookup(contractAddress: v1.ContractAddress, key: HexString, blockHash?: HexString): Promise<HexString>;
    /**
     ...
     */
    getIdentityProviders(blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<v1.IpInfo>;
    /**
     ...
     * @returns an async iterable of identity provider info objects.
     */
    getAnonymityRevokers(blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<v1.ArInfo>;
    /**
     ...
     */
    getBlocksAtHeight(blockHeightRequest: v1.BlocksAtHeightRequest): Promise<HexString[]>;
    /**
     ...
     */
    getBlockInfo(blockHash?: HexString): Promise<v1.BlockInfo>;
    /**
     ...
     */
    getBakerList(blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<v1.BakerId>;
    /**
     ...
     */
    getPoolDelegators(baker: v1.BakerId, blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<v1.DelegatorInfo>;
    /**
     ...
     */
    getPoolDelegatorsRewardPeriod(baker: v1.BakerId, blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<v1.DelegatorRewardPeriodInfo>;
    /**
     ...
     * @returns a stream of DelegatorInfo
     */
    getPassiveDelegators(blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<v1.DelegatorInfo>;
    /**
     ...
     * @returns a stream of DelegatorRewardPeriodInfo
     */
    getPassiveDelegatorsRewardPeriod(blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<v1.DelegatorRewardPeriodInfo>;
    /**
     ...
     */
    getElectionInfo(blockHash?: HexString): Promise<v1.ElectionInfo>;
    /**
     ...
     */
    getAccountNonFinalizedTransactions(accountAddress: AccountAddress, abortSignal?: AbortSignal): AsyncIterable<HexString>;
    /**
     ...
     */
    getBlockTransactionEvents(blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<BlockItemSummary>;
    /**
     ...
     */
    getNextUpdateSequenceNumbers(blockHash?: HexString): Promise<v1.NextUpdateSequenceNumbers>;
    /**
     * Shut down the node.
     ...
     * @returns a stream of block item summaries
     */
    getBlockSpecialEvents(blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<v1.BlockSpecialEvent>;
    /**
     ...
     */
    getBlockPendingUpdates(blockHash?: HexString, abortSignal?: AbortSignal): AsyncIterable<v1.PendingUpdate>;
    /**
     ...
     */
    getBlockFinalizationSummary(blockHash?: HexString): Promise<v1.BlockFinalizationSummary>;
}
