...
import { AccountInfo, AccountTransaction, AccountTransactionSignature, ConsensusStatus, ContractAddress, ContractContext, CryptographicParameters, InstanceInfo, InvokeContractResultV1, NextAccountNonce, SignedCredentialDeploymentDetails, TransactionStatus, Versioned } from './types';
...
export declare class JsonRpcClient {
     ...
     */
    invokeContract(contractContext: ContractContext, blockHash?: string): Promise<InvokeContractResultV1 | undefined>;
}
