...
declare class CIS2DryRun {
     ...
     */
    transfer(sender: CIS2.Address, transfer: CIS2.Transfer, blockHash?: HexString): Promise<InvokeContractResult>;
    transfer(sender: CIS2.Address, transfers: CIS2.Transfer[], blockHash?: HexString): Promise<InvokeContractResult>;
    /**
     ...
     * @returns {InvokeContractResult} the contract invocation result, which includes whether or not the invocation succeeded along with the energy spent.
     */
    updateOperator(owner: CIS2.Address, update: CIS2.UpdateOperator, blockHash?: HexString): Promise<InvokeContractResult>;
    updateOperator(owner: CIS2.Address, updates: CIS2.UpdateOperator[], blockHash?: HexString): Promise<InvokeContractResult>;
    /**
 ...
 */
export declare class CIS2Contract {
    private grpcClient;
    private contractAddress;
    private contractName;
     ...
     */
    createTransfer(metadata: CIS2.CreateTransactionMetadata, transfer: CIS2.Transfer): CIS2.UpdateTransaction;
    /**
     ...
     * @returns {CIS2.UpdateTransaction} An object containing the parts of the transaction needed for submission.
     */
    createTransfer(metadata: CIS2.CreateTransactionMetadata, transfers: CIS2.Transfer[]): CIS2.UpdateTransaction;
    createTransfer(metadata: CIS2.CreateTransactionMetadata, transfers: CIS2.Transfer | CIS2.Transfer[]): CIS2.UpdateTransaction;
    /**
     ...
     */
    transfer(metadata: CIS2.TransactionMetadata, transfer: CIS2.Transfer, signer: AccountSigner): Promise<HexString>;
    /**
     ...
     * @returns {Promise<HexString>} The transaction hash of the update transaction
     */
    transfer(metadata: CIS2.TransactionMetadata, transfers: CIS2.Transfer[], signer: AccountSigner): Promise<HexString>;
    /**
     ...
     * @returns {CIS2.UpdateTransaction} An object containing the parts of the transaction needed for submission.
     */
    createUpdateOperator(metadata: CIS2.CreateTransactionMetadata, update: CIS2.UpdateOperator): CIS2.UpdateTransaction;
    /**
     ...
     * @returns {CIS2.UpdateTransaction} An object containing the parts of the transaction needed for submission.
     */
    createUpdateOperator(metadata: CIS2.CreateTransactionMetadata, updates: CIS2.UpdateOperator[]): CIS2.UpdateTransaction;
    createUpdateOperator(metadata: CIS2.CreateTransactionMetadata, updates: CIS2.UpdateOperator | CIS2.UpdateOperator[]): CIS2.UpdateTransaction;
    /**
     ...
     * @returns {Promise<HexString>} The transaction hash of the update transaction
     */
    updateOperator(metadata: CIS2.TransactionMetadata, update: CIS2.UpdateOperator, signer: AccountSigner): Promise<HexString>;
    /**
     ...
     * @returns {Promise<HexString>} The transaction hash of the update transaction
     */
    updateOperator(metadata: CIS2.TransactionMetadata, updates: CIS2.UpdateOperator[], signer: AccountSigner): Promise<HexString>;
    /**
     ...
     */
    balanceOf(query: CIS2.BalanceOfQuery, blockHash?: HexString): Promise<bigint>;
    /**
     ...
     */
    balanceOf(queries: CIS2.BalanceOfQuery[], blockHash?: HexString): Promise<bigint[]>;
    /**
     ...
     */
    operatorOf(query: CIS2.OperatorOfQuery, blockHash?: HexString): Promise<boolean>;
    /**
     ...
     */
    operatorOf(queries: CIS2.OperatorOfQuery[], blockHash?: HexString): Promise<boolean[]>;
    /**
     ...
     */
    tokenMetadata(tokenId: HexString, blockHash?: HexString): Promise<CIS2.MetadataUrl>;
    /**
     ...
     */
    tokenMetadata(tokenIds: HexString[], blockHash?: HexString): Promise<CIS2.MetadataUrl[]>;
    /**
