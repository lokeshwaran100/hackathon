...
import { HexString, TransactionSummaryType, TransactionStatusEnum } from '../types';
...
export declare type BlockItemSummary = AccountTransactionSummary | AccountCreationSummary | UpdateSummary;
...
export declare type BlockItemStatus = CommittedBlockItem | FinalizedBlockItem | PendingBlockItem;
