...
export declare type KeyUpdate = HigherLevelKeyUpdate | AuthorizationKeysUpdate;
export interface Fraction {
    numerator: bigint;
    denominator: bigint;
}
export declare type AddIdentityProvider = IpInfo;
export declare type AddAnonymityRevoker = ArInfo;
...
export declare type AuthorizationKeysUpdate = {
